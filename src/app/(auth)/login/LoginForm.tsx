    ...
    >
      ...
      <div className="flex flex-col items-center gap-3 text-center">
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-fg-muted">Sign in to SBL Tracker</p>
        </div>
      </div>
      ...
      <div className="relative">
        ...
        <div className="relative flex justify-center">
          <span className="bg-surface px-3 text-xs text-fg-muted">or continue with</span>
        </div>
      </div>
      ...
      <p className="text-center text-sm text-fg-muted">
        ...
        <Link href="/signup" className="text-brand font-medium hover:underline underline-offset-2">
          Sign up
        </Link>
      </p>
    </motion.div>
