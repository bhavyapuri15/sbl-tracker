...
('Leg Curl (Seated)',        'leg-curl-seated',          ARRAY['hamstrings'],           ARRAY[],                        'machine',    'isolation','pull',   false),
('Leg Curl (Lying)',         'leg-curl-lying',           ARRAY['hamstrings'],           ARRAY[],                        'machine',    'isolation','pull',   false),
('Leg Extension',            'leg-extension',            ARRAY['quads'],                ARRAY[],                        'machine',    'isolation','push',   false),
...
('Seated Calf Raise',        'seated-calf-raise',        ARRAY['calves'],               ARRAY[],                        'machine',    'isolation','push',   false),
('Standing Calf Raise',      'standing-calf-raise',      ARRAY['calves'],               ARRAY[],                        'machine',    'isolation','push',   false),
...
('Cable Fly (Low)',          'cable-fly-low',            ARRAY['chest'],                ARRAY[],                        'cable',      'isolation','push',   false),
('Cable Fly (Mid)',          'cable-fly-mid',            ARRAY['chest'],                ARRAY[],                        'cable',      'isolation','push',   false),
('Pec Deck',                 'pec-deck',                 ARRAY['chest'],                ARRAY[],                        'machine',    'isolation','push',   false),
...
('Shrug (Barbell)',          'shrug-barbell',            ARRAY['traps'],                ARRAY[],                        'barbell',    'isolation','pull',   false),
...
('Lateral Raise',            'lateral-raise',            ARRAY['shoulders'],            ARRAY[],                        'dumbbell',   'isolation','push',   false),
('Cable Lateral Raise',      'cable-lateral-raise',      ARRAY['shoulders'],            ARRAY[],                        'cable',      'isolation','push',   true),
...
('Incline Dumbbell Curl',    'incline-dumbbell-curl',    ARRAY['biceps'],               ARRAY[],                        'dumbbell',   'isolation','pull',   true),
('Cable Curl',               'cable-curl',               ARRAY['biceps'],               ARRAY[],                        'cable',      'isolation','pull',   false),
('Preacher Curl',            'preacher-curl',            ARRAY['biceps'],               ARRAY[],                        'ez-bar',     'isolation','pull',   false),

-- ── TRICEPS ──────────────────────────────────────────────────────────
('Tricep Pushdown (Bar)',    'tricep-pushdown-bar',      ARRAY['triceps'],              ARRAY[],                        'cable',      'isolation','push',   false),
('Tricep Pushdown (Rope)',   'tricep-pushdown-rope',     ARRAY['triceps'],              ARRAY[],                        'cable',      'isolation','push',   false),
('Skull Crusher',            'skull-crusher',            ARRAY['triceps'],              ARRAY[],                        'ez-bar',     'isolation','push',   false),
('Close-Grip Bench Press',   'close-grip-bench-press',   ARRAY['triceps'],              ARRAY['chest'],                 'barbell',    'compound', 'push',   false),
('Overhead Tricep Ext.',     'overhead-tricep-extension',ARRAY['triceps'],              ARRAY[],                        'cable',      'isolation','push',   false),
('Dip (Tricep)',             'dip-tricep',               ARRAY['triceps'],              ARRAY['chest'],                 'bodyweight', 'compound', 'push',   false),

-- ── CORE ─────────────────────────────────────────────────────────────
('Cable Crunch',             'cable-crunch',             ARRAY['abs'],                  ARRAY[],                        'cable',      'isolation','pull',   false),
('Hanging Leg Raise',        'hanging-leg-raise',        ARRAY['abs'],                  ARRAY[],                        'bodyweight', 'isolation','pull',   false),
